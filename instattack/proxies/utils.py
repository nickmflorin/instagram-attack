...
def filter_saved_proxy(proxy, max_error_rate=None, max_resp_time=None):
...
def filter_saved_proxies(proxies, max_error_rate=None, max_resp_time=None):
    return [
        filtered_proxy[0] for filtered_proxy in [
            filter_saved_proxy(proxy, max_error_rate=max_error_rate, max_resp_time=max_resp_time)
