...
from instattack.lib.utils import get_app_stack_at, task_is_third_party, cancel_remaining_tasks
from instattack.app import exceptions

from .proxies.cli import *  # noqa
from .users.cli import *  # noqa
from .login.cli import *  # noqa
...
class operator(HandlerMixin):
    ...
    def setup_logger(self, loop):
        from instattack.lib.logger import disable_external_loggers
    ...
    async def shutdown_async_loggers(self, loop):
        from instattack.lib.logger import AsyncLogger
